...
class ProjetosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create projeto" do
    assert_difference('Projeto.count') do
      post projetos_url, params: { projeto: { dercricao: @projeto.dercricao, nome: @projeto.nome } }
    end
  ...
  test "should update projeto" do
    patch projeto_url(@projeto), params: { projeto: { dercricao: @projeto.dercricao, nome: @projeto.nome } }
